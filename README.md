...
| GeminiFusion | MiT-B2|RGB+Event| 58.5 | [model](https://github.com/JiaDingCN/GeminiFusion/releases/download/DeLiVER_V2/geminifusion_b2_deliver_rgbe.pth) &#124; [config](configs/deliver_rgbe_8cards_2e-4.yaml) |
| GeminiFusion | MiT-B2|RGB+LiDAR| 58.6 |  [model](https://github.com/JiaDingCN/GeminiFusion/releases/download/DeLiVER_V2/geminifusion_b2_deliver_rgbl.pth) &#124; [config](configs/deliver_rgbl_8cards_2e-4.yaml) |
